...
에세이에는 예외가 하나 있다. **리듬을 위한 의도적 단문과 명사구는 공통 규범 3번(완성형 종결)의 예외다.** "짧게. 그다음 중간."은 위 리듬 절이 요구하는 길이 변주다. 소리 내어 읽어서 의도한 호흡인지, 흐린 말인지로 가른다. 흐린 말이면 끝맺는다.

- **공통 4번(조사·어미 생략 금지)도 리듬 장치에 한해 예외다.** 리듬 장치가 아닌 자리에서 조사가 빠져 뜻이 흐려졌다면 되살린다. 압축된 문장을 전부 "리듬"으로 정당화하지 않는다.
- **엠대시(공통 5번)는 에세이에서도 자제한다.** 대시로 함축한 관계는 대개 필자가 아직 정하지 못한 관계다. 그런데/그래서로 문장을 잇거나 아예 끊는다.
...
WRITE-ESSAY AUDIT:
  ...
  명사구 사슬: FLAG — "실패 경험의 학습 효과의 크기" → "실패에서 배운 것이 얼마나 컸는지"
  엠대시:      FLAG — "배포를 미뤘다 — 테스트가 안 끝났다" → "테스트가 안 끝나서 배포를 미뤘다"
