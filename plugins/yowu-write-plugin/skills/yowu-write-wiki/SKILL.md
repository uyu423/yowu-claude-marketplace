...
- **절차 목록은 각 단계마다 완성형 종결을 지킨다.** 예외가 아니다. 행위 주체와 서술어를 갖춘 문장으로 쓴다(아래 "풀어쓰기 기술" 3번, 그리고 형식 규칙의 "한 단계 한 행동"). 단 주체가 절차 전체에서 같으면 도입부에 한 번 밝히고 각 단계에서는 생략한다. 단계마다 주체가 바뀌는 절차에서만 매 단계에 명시한다. 절차에서 주어와 서술어를 지우면 사고가 난다. 제외되는 것은 섹션 제목과 열거용 불릿뿐이다.
